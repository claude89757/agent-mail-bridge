...
| [adr/](adr/) | active | architecture decision records (one per P0 spike and beyond) |
| [reference/](reference/) | archive | generated protocol schemas (codex app-server v1/v2) |
| [research/](research/) | archive | pre-development research; superseded parts marked, spec wins |
| [superpowers/specs/](superpowers/specs/) | **authoritative** | the roadmap design spec — single source of truth |

The single authoritative spec is
[`superpowers/specs/2026-07-17-agent-mail-bridge-roadmap-design.md`](superpowers/specs/2026-07-17-agent-mail-bridge-roadmap-design.md).
Where any other document conflicts with it, the spec wins.
